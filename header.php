...
<head>
	...
	<link rel="manifest" href="<?php echo esc_url( get_template_directory_uri() . '/assets/images/site.webmanifest?ver=2.0.22' ); ?>">
	<link rel="apple-touch-icon" sizes="180x180" href="<?php echo esc_url( get_template_directory_uri() . '/assets/images/apple-touch-icon.png?ver=2.0.22' ); ?>">
	<?php if ( ! has_site_icon() ) : ?>
		<link rel="icon" href="<?php echo esc_url( get_template_directory_uri() . '/assets/images/favicon.svg?ver=2.0.22' ); ?>" type="image/svg+xml">
	<?php endif; ?>
	<?php wp_head(); ?>
</head>
<body <?php body_class(); ?>>
